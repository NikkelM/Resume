\addblocktext{Summary}{
	I am a Computer Science student currently studying for my Bachelor's degree at the Hasso-Plattner-Institute in Potsdam, Germany. Some of the fields I am most interested
	in are CI/CD, Agile methodology and Machine Learning (Reinforcement Learning), which manifests itself in the topic of my Bachelor's Thesis,
	\emph{Monitoring Reliability and Robustness of Agents for Dynamic Pricing in different (Re-)Commerce Markets}.}
%
%Education
\section{Education}
...
\explanationdetail{During my studies, I was most interested in Machine Learning and agile development methods, but also gained experience in
	3D-Computergraphics, Web-development and Database management.}
...
\newcommand{\skilltwo}{\createskill{Software Development}{
		CI/CD \cpshalf Git \cpshalf Agile Methodology \cpshalf Programming Paradigms \cpshalf CLI}}
%
\newcommand{\skillthree}{\createskill{Frameworks \ \& \ Libraries}{
		Matplotplib \cpshalf Numpy \cpshalf Gym \cpshalf PyTorch \cpshalf Tensorflow}}
%
\newcommand{\skillfour}{\createskill{Languages}{
		\textbf{\emph{Native:}} German \ \
		\textbf{\emph{Fluent:}} English \ \
		\textbf{\emph{Beginner:}} Italian}}
%
