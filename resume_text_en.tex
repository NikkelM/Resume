...
\explanationdetail{During my studies, I was most interested in machine learning and agile development methods, but also gained experience in
	computergraphics, web-development and database management.\\Bachelor's project: \emph{"Online Marketplace Simulation: A Testbed for Self-Learning Agents"}}
...
\explanation{Intern}
\explanationdetail{Tasks included introducing visiting companies from abroad to the "Silicon Valley Mindset" and conducting interviews with personalities from the Automobile sector.}
%
% Skills
\section{Skills}
%
