...
\explanationdetail{
	\begin{coloreditemize}
		...
		\item Technologies: Javascript, Webpack, Firebase (Realtime Database, Auth, Functions), Chromium APIs, YouTube Data API, Mocha.
	\end{coloreditemize}
}
%
\datedExperienceLink{Todo PR Checker}{\href{https://github.com/NikkelM/Todo-PR-Checker}{\faGithub{} GitHub}}{GitHub App}
\explanationdetail{
	\begin{coloreditemize}
