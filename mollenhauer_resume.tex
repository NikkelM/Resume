...
\section{Experience}
%
\datedExperienceTitle{Microsoft}{Site Reliability Engineer, Azure}{Dublin, Ireland - 09/2023 - present}
\explanationdetail{
	\begin{coloreditemize}
		...
		\item My work has resulted in a reduction of noisy incidents for our on-call engineers, as well as improved detection of livesite issues.
...
\explanationdetail{
	\begin{coloreditemize}
		\item Browser extension with more than 4,000 daily active users that allows for truly random video shuffling from any YouTube channel.
