...
\section{Experience}
%
\datedExperienceTitle{Microsoft}{Site Reliability Engineer - Multiple Service Engagements}{Dublin, Ireland - 09/2023 - present}
\explanationdetail{
	\begin{coloreditemize}
		...
		\item TTD for certain high-impact failure modes has been improved by more than 2 hours of earlier detection, down to minutes.
		\item Enabled cost savings of more than 100,000 USD per month through identification and removal of duplicated resources.
	\end{coloreditemize}
}
%
...
%
\datedExperienceTitle{Microsoft}{Site Reliability Engineer - Azure Resource Manager (ARM)}{Dublin, Ireland - 09/2022 - 11/2022}
\explanationdetail{
	\begin{coloreditemize}
		\item Responsible for the creation of 3 types of entirely new, automated monitoring probes for the synthetic monitoring platform of the Azure Control Plane, testing previously unmonitored customer scenarios with read-write operations of 10+ core Azure services.
		...
		\item Enhanced the monitoring platform by ensuring new probes were easily extendable and maintainable, allowing future growth.
	\end{coloreditemize}
}
%
...
\explanationdetail{
	\begin{coloreditemize}
		\item Browser extension with over 7,000 weekly active users that allows for truly random video shuffling from any YouTube channel.
...
\explanationdetail{
	\begin{coloreditemize}
		\item JSON-to-Notion: Imports JSON-formatted data to a Notion database, eliminating the need to convert it to CSV. \href{https://github.com/NikkelM/JSON-to-Notion}{\faGithub\ GitHub}
		\item Steam API integration: Synchronizes and imports data from the Steam API to Notion automatically. \href{https://github.com/NikkelM/Notion-Steam-API-Integration}{\faGithub\ GitHub}
...
\section{Education}
%
\datedExperienceLink{Hasso-Plattner-Institute}{B.Sc. IT-Systems Engineering, Grade 1.6 (Scale 1-5)}{Potsdam, Germany - 2019 - 2023}
\explanationdetail{
	\begin{coloreditemize}
