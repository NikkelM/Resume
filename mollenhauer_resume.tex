...
\explanationdetail{
	\begin{coloreditemize}
		\item As a member of the Azure Resource Manager SRE team, I am working on improving the observability capabilities of our service.
		\item I am involved in synthetic and sync/async monitoring, as well as metric emission and configuration.
		\item My work has resulted in a reduction of noisy incidents for our on-call engineers, as well as improved detection of live incidents.
		\item Alerting for certain high-impact failure modes has been improved by up to 2 hours of earlier detection.
	\end{coloreditemize}
}
%
...
%
\datedExperienceTitle{Microsoft}{Site Reliability Engineer}{Dublin, Ireland - 09/2022 - 11/2022}
\explanationdetail{
	\begin{coloreditemize}
...
%%%%%%%%%%%
\section{Projects}
\explanation{All of my projects are open-source on \href{https://github.com/NikkelM}{\faGithub{} GitHub} and feature extensive CI\&CD pipelines, leveraging GitHub Actions and Releases.}
%
...
\explanationdetail{
	\begin{coloreditemize}
		\item Browser extension with more than 2,500 daily active that allows users to truly randomly shuffle videos from any YouTube channel.
...
\explanationdetail{
	\begin{coloreditemize}
		...
		\item Offers powerful customization options such as excluding files using regular expressions or adding support for new languages.
