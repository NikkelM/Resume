...
\explanationdetail{
	\begin{coloreditemize}
		\item I am currently working on the Azure Resource Manager Control Plane team, where I am extending the internal monitoring tools of the Azure platform.
	\end{coloreditemize}
}
%
...
\explanationdetail{
	\begin{coloreditemize}
		\item Created three types of entirely new automated monitoring probes for the synthetic monitoring of the Azure Resource Manager Control Plane, each testing read-write operations of 10+ core Azure services.
		...
		\item Presented the results of my project to other engineers during an organization-wide weekly Q\&A session.
	\end{coloreditemize}
}
%
...
\explanation{B.Sc., IT-Systems Engineering, Grade 1.6}
\explanationdetail{
	\begin{coloreditemize}
...
\explanationdetail{
	\begin{coloreditemize}
		\item YouTube extension that inserts 'Shuffle' buttons on channel and video pages.
		\item Offers a variety of customization options, such as excluding shorts or shuffling only from recent videos.
		\item More than 1,000 weekly active users as of July 2023.
